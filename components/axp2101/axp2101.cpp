...
void AXP2101Component::setup()
{
    ...
    * */
    ...
    // Force add pull-up
    this->irq_pin_ = new esphome::GPIOPin(
    pmu_irq_pin,
    esphome::GPIOPin::FLAG_INPUT | esphome::GPIOPin::FLAG_PULLUP
    );
    this->irq_pin_->setup();
    this->irq_pin_->attach_interrupt(setFlag, esphome::GPIOPin::INTERRUPT_FALLING_EDGE);
